...
// Phase 4 — public /portfolio page.
//
// Reads from CMS (`pages` table, slug='portfolio'). Falls back
// to the existing home-page Projects component so the public
// site is never broken before the admin publishes a CMS row.
// ──────────────────────────────────────────────────────────
    ...
    return (
        <section className="pt-24 pb-20 max-w-6xl mx-auto px-6">
            ...
            <p className="text-xs text-gray-400 mt-12 italic">
                Showing default content — sign in as admin and publish a <code>portfolio</code> page in the CMS to replace this.
            </p>
        </section>
    );
};

const PortfolioPage = () => <CMSPage slug="portfolio" title="Portfolio — BuildWithLami" fallback={<PortfolioFallback />} />;
