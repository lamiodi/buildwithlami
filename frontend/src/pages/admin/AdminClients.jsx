                      ...
                      {clients.filter(c => 
                        ...
                        <tr key={client.id} className="hover:bg-gray-50 dark:hover:bg-gray-900/50 transition-colors">
                          ...
                          <td className="py-4 px-6 text-right space-x-2 whitespace-nowrap">
                            {client.phone && (
                              <a
                                href={`https://wa.me/${String(client.phone).replace(/[^\d+]/g, '').replace(/^\+/, '')}?text=${encodeURIComponent(`Hi ${client.name}, this is Lami Odi from BuildWithLami — following up on your project.`)}`}
                                target="_blank"
