...
const ProjectsPage = () => {
  ...
  return (
    <div className="min-h-screen pt-28 pb-32 bg-gray-50 dark:bg-[#07090E] text-black dark:text-white transition-colors duration-300 font-body selection:bg-[#0079FF] selection:text-white">
      {/* Hero Header */}
      <section className="px-6 md:px-12 max-w-7xl mx-auto mb-14">
        ...
        >
          <Link to="/" className="inline-flex items-center text-xs font-bold uppercase tracking-widest text-gray-600 dark:text-gray-400 hover:text-[#0079FF] dark:hover:text-[#389BFF] transition-colors mb-8 group">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              <p className="uppercase tracking-widest text-xs text-[#0079FF] dark:text-[#389BFF] font-bold mb-3">Software & Web Engineering Portfolio</p>
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-bold tracking-tight text-black dark:text-white leading-[0.9]">
                Selected<br />
                <span className="bg-gradient-to-r from-[#0079FF] via-blue-500 to-indigo-400 bg-clip-text text-transparent">Works</span>
              </h1>
            </div>
            <p className="text-gray-700 dark:text-gray-300 text-base md:text-lg max-w-md font-light leading-relaxed md:text-right">
              A curated collection of software, web applications, and digital platforms engineered for businesses and real-world scale.
            </p>
          </div>
        </motion.div>

        {/* Divider */}
        <div className="w-full h-px bg-gray-200 dark:border-white/10 mt-12" />
      </section>
            ...
            return (
              <button
                ...
                className={`px-4 md:px-5 py-2.5 text-xs font-bold uppercase tracking-widest rounded-full transition-all duration-300 flex items-center gap-2 border ${
                  isActive
                    ? 'bg-[#0079FF] text-white border-[#0079FF] shadow-lg shadow-[#0079FF]/20'
                    : 'border-gray-200 dark:border-white/10 text-gray-700 dark:text-gray-300 hover:border-[#0079FF]/40 hover:text-[#0079FF] dark:hover:text-[#389BFF] bg-white dark:bg-[#0E131F]'
                }`}
              >
                <span>{filter}</span>
      ...
      <section className="px-6 md:px-12 max-w-7xl mx-auto space-y-16">
        ...
        >
          {filteredProjects.length === 0 ? (
            <div className="text-center py-24 border border-dashed border-gray-300 dark:border-white/10 rounded-2xl bg-white dark:bg-[#0E131F] p-8">
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-4 font-medium">
                No projects found under the <span className="text-[#0079FF] dark:text-[#389BFF] font-bold">{activeFilter}</span> category.
              </p>
              <button
                onClick={() => setActiveFilter('All')}
                className="px-6 py-3 bg-[#0079FF] hover:bg-[#0066D6] text-white text-xs font-bold uppercase tracking-widest transition-colors rounded-lg shadow-md"
              >
                View All Projects
              </button>
            </div>
            ...
            <div className="space-y-20">
              ...
              {featuredProject && (
                <motion.div
                  ...
                  className="bg-white dark:bg-[#0E131F] border border-gray-200 dark:border-white/10 rounded-3xl overflow-hidden shadow-xl group hover:border-[#0079FF]/50 transition-all duration-500"
                >
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-between p-6 md:p-8">
                        <div className="flex items-center gap-2">
                          <span className="bg-[#0079FF] text-white text-[11px] font-bold uppercase tracking-widest px-3.5 py-1.5 rounded-full shadow-md">
                            ★ Featured Case Study
                          </span>
                        </div>
                    ...
                    <div className="lg:col-span-5 p-8 md:p-10 flex flex-col justify-between space-y-6">
                      <div className="space-y-4">
                        <span className="text-xs uppercase tracking-widest font-bold text-[#0079FF] dark:text-[#389BFF]">
                        ...
                        <div className="pt-3 border-t border-gray-100 dark:border-white/5 space-y-2">
                          <div className="flex items-center gap-2 text-xs text-gray-800 dark:text-gray-200 font-medium">
                            <span className="text-[#0079FF] dark:text-[#389BFF]">✦</span>
                      ...
                      <div className="pt-4 border-t border-gray-200 dark:border-white/10 flex flex-wrap items-center gap-3">
                        <Link
                          ...
                          className="flex-1 inline-flex items-center justify-center bg-[#0079FF] hover:bg-[#0066D6] text-white font-bold px-6 py-3.5 text-xs uppercase tracking-widest transition-colors rounded-xl shadow-lg shadow-[#0079FF]/20 text-center"
                        >
                          View Case Study →
                        </Link>
                        {featuredProject.live_url && featuredProject.live_url !== '#' && (
                          <a
                            ...
                            className="inline-flex items-center justify-center border border-gray-300 dark:border-white/20 text-black dark:text-white font-bold px-5 py-3.5 text-xs uppercase tracking-widest hover:border-[#0079FF] hover:text-[#0079FF] dark:hover:text-[#389BFF] transition-colors rounded-xl"
                          >
                            Live Demo ↗
                          </a>
                        )}
              ...
              {remainingProjects.length > 0 && (
                <div>
                  <div className="flex items-center justify-between mb-8">
                    <div>
                      <p className="text-xs font-bold uppercase tracking-widest text-[#0079FF] dark:text-[#389BFF] mb-1">Portfolio Grid</p>
                    ...
                    {remainingProjects.map((project) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className="bg-white dark:bg-[#0E131F] border border-gray-200 dark:border-white/10 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:border-[#0079FF]/50 transition-all group flex flex-col justify-between"
                        >
                          {/* Image Header */}
                          <div 
                          ...
                          <div className="p-6 md:p-8 flex-1 flex flex-col justify-between space-y-6">
                            <div className="space-y-3">
                              <h4 
                                onClick={() => navigate(`/projects/${projKey}`)}
                                className="text-xl md:text-2xl font-heading font-bold text-black dark:text-white group-hover:text-[#0079FF] dark:group-hover:text-[#389BFF] transition-colors cursor-pointer"
                              >
                                {project.title}
                              </h4>
                            ...
                            <div className="space-y-4 pt-4 border-t border-gray-100 dark:border-white/5">
                              ...
                              <div className="flex items-center gap-3 pt-2">
                                <Link
                                  to={`/projects/${projKey}`}
                                  className="flex-1 inline-flex items-center justify-center bg-black text-white dark:bg-white dark:text-black font-bold px-4 py-2.5 text-xs uppercase tracking-widest hover:bg-[#0079FF] dark:hover:bg-[#0079FF] dark:hover:text-white transition-colors rounded-lg text-center"
                                >
                                  View Case Study →
                                </Link>
                                {hasLiveDemo && (
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center justify-center border border-gray-200 dark:border-white/20 text-black dark:text-white font-bold px-4 py-2.5 text-xs uppercase tracking-widest hover:border-[#0079FF] hover:text-[#0079FF] dark:hover:text-[#389BFF] transition-colors rounded-lg"
                                  >
                                    Live Demo ↗
                                  </a>
                                )}
      ...
      <section className="px-6 md:px-12 max-w-7xl mx-auto mt-32">
        ...
        >
          ...
          <p className="text-xs uppercase tracking-widest text-[#0079FF] dark:text-[#389BFF] font-bold mb-3">Have a software build in mind?</p>
          <h2 className="text-4xl md:text-6xl font-heading font-bold text-black dark:text-white mb-6">
            Let's engineer <span className="bg-gradient-to-r from-[#0079FF] via-blue-500 to-indigo-400 bg-clip-text text-transparent">together</span>
          </h2>
          <p className="text-gray-700 dark:text-gray-300 text-base md:text-lg max-w-2xl mx-auto mb-10 font-light leading-relaxed">
            Tell me what system you're building, user workflows, and timelines. I'll personally review the requirements and map out the right architecture.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              <Link
                to="/contact"
                className="inline-flex items-center justify-center bg-[#0079FF] hover:bg-[#0066D6] text-white font-bold px-8 py-4 text-xs uppercase tracking-widest transition-colors rounded-xl shadow-lg shadow-[#0079FF]/25"
              >
            ...
            >
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center border border-gray-300 dark:border-white/20 text-black dark:text-white font-bold px-8 py-4 text-xs uppercase tracking-widest hover:border-[#0079FF] hover:text-[#0079FF] dark:hover:text-[#389BFF] transition-colors rounded-xl"
              >
                WhatsApp Direct ↗
              </a>
            </motion.div>
