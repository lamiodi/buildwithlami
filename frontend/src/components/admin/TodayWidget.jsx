...
import { DashboardIcon, CoreIcon, ActionIcon } from '../../data/adminIcons.jsx';

const Icon = {
    Leads: DashboardIcon.Lead,
    Invoice: CoreIcon.CreditCard,
    Globe: DashboardIcon.Globe,
    Review: DashboardIcon.Eye,
    Feedback: DashboardIcon.Chat,
    Bell: CoreIcon.Bell,
    Mail: CoreIcon.Mail,
